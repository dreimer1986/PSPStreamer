# Shared playlist — server 0.1.59 and matching PSP client
...
- Turn off **Use playlist instead of folder order** for ordinary folder
  continuation. List order deliberately overrides folder shuffle.
...
list/folder-order switch. **Circle** closes the editor; **Left** returns from
...
playlist repeat/shuffle, per-entry quality, or gapless music playback.
