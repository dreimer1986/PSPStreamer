...
def ffmpeg_command(source: Path, audio_track: int, container: str = "mp4", low_bandwidth: bool = False,
                   ...
                   start_seconds: float = 0) -> list[str]:
...
class AppHandler(BaseHTTPRequestHandler):
    ...
    def transcode(self, token: str, audio_track: int, container: str, low_bandwidth: bool = False,
        ...
        try:
            ...
            self.connection.settimeout(float(os.environ.get("CLIENT_WRITE_TIMEOUT", "5")))
            ...
            process = subprocess.Popen(
                ffmpeg_command(source, audio_track, container, low_bandwidth, subtitle_track, audio_bitrate, subtitle_source, start_seconds),
