...
typedef enum {
    HELP_PAGE_BROWSE, HELP_PAGE_NAVIGATION, HELP_PAGE_PLAYLIST, HELP_PAGE_OPTIONS, HELP_PAGE_QUALITY,
    HELP_PAGE_VIDEO, HELP_PAGE_VIDEO_MORE, HELP_PAGE_MUSIC, HELP_PAGE_MUSIC_MORE,
    HELP_PAGE_VISUALS, HELP_PAGE_PRESETS, HELP_PAGE_FLIGHT, HELP_PAGE_DOWNLOAD, HELP_PAGE_QUEUE,
    HELP_PAGE_LOCAL, HELP_PAGE_TRAVEL, HELP_PAGE_SETTINGS, HELP_PAGE_COMFORT, HELP_PAGE_RESUME, HELP_PAGE_PROFILES, HELP_PAGE_KEYBOARD, HELP_PAGE_PLUGIN, HELP_PAGE_PRESET_SETTINGS, HELP_PAGE_POWER, HELP_PAGE_SCREEN, HELP_PAGE_TV,
    HELP_PAGE_TV_MORE, HELP_PAGE_NETWORK, HELP_PAGE_REMOTE, HELP_PAGE_REMOTE_TEXT, HELP_PAGE_COUNT
} HelpPageId;
typedef struct {
    const char *title;
...
static const HelpPage help_pages[HELP_PAGE_COUNT]={
    [HELP_PAGE_PLAYLIST]={HELP_BROWSE,PSP_CTRL_CROSS|PSP_CTRL_TRIANGLE|PSP_CTRL_CIRCLE},
    ...
    [HELP_PAGE_FLIGHT]={HELP_VISUALS,PSP_CTRL_UP|PSP_CTRL_DOWN|PSP_CTRL_LTRIGGER|PSP_CTRL_RTRIGGER|PSP_CTRL_TRIANGLE},
    ...
    [HELP_PAGE_TRAVEL]={HELP_DOWNLOADS,PSP_CTRL_LTRIGGER|PSP_CTRL_CROSS|PSP_CTRL_CIRCLE},
    [HELP_PAGE_SETTINGS]={HELP_SETTINGS,HELP_DPAD|PSP_CTRL_CROSS|PSP_CTRL_START|PSP_CTRL_CIRCLE},
    [HELP_PAGE_COMFORT]={HELP_SETTINGS,HELP_DPAD|PSP_CTRL_CROSS|PSP_CTRL_CIRCLE},
    [HELP_PAGE_RESUME]={HELP_SETTINGS,PSP_CTRL_CROSS|PSP_CTRL_SQUARE|PSP_CTRL_CIRCLE},
    [HELP_PAGE_PROFILES]={HELP_SETTINGS,HELP_DPAD|PSP_CTRL_CROSS|PSP_CTRL_SQUARE|PSP_CTRL_TRIANGLE|PSP_CTRL_CIRCLE},
    ...
    [HELP_PAGE_PLUGIN]={HELP_SETTINGS,HELP_DPAD|PSP_CTRL_CROSS|PSP_CTRL_START|PSP_CTRL_CIRCLE},
    [HELP_PAGE_PRESET_SETTINGS]={HELP_SETTINGS,HELP_DPAD|PSP_CTRL_CROSS|PSP_CTRL_START|PSP_CTRL_CIRCLE},
    ...
    [HELP_PAGE_REMOTE]={HELP_NETWORK,HELP_DPAD|PSP_CTRL_SELECT},
    [HELP_PAGE_REMOTE_TEXT]={HELP_NETWORK,PSP_CTRL_CROSS|PSP_CTRL_START|PSP_CTRL_CIRCLE}
};
#include "help_en.h"
#include "help_de.h"
