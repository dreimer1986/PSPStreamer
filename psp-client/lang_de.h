...
static const char *const lang_de[TXT_COUNT] = {
    ...
    [TXT_PLEASE_WAIT] = "WARTEN...",
    [TXT_NO_VIDEO] = "Kein Video",
    [TXT_STREAM_HAS] = "wurde",
    ...
    [TXT_SAVED_FOR] = "Gemerkt:",
    [TXT_NEXT_MUSIC] = "Nächster",
    [TXT_STREAM_BANG] = "Musiktitel",
    [TXT_PLAY_ORDER] = "WIEDERGABEFOLGE",
    [TXT_SEQUENTIAL] = "REIHENFOLGE",
    [TXT_SHUFFLE] = "ZUFALL",
    [TXT_AUDIO_SUB] = "TON & SUB",
    [TXT_NEXT_PLAY] = "Nächste",
    [TXT_BACK] = "Wiedergabe",
    ...
    [TXT_PLAYLIST] = "Wiedergabeliste",
    [TXT_PLAYLIST_UP] = "Nach oben",
    [TXT_PLAYLIST_DOWN] = "Nach unten",
