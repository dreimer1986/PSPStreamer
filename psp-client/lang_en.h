...
static const char *const lang_en[TXT_COUNT] = {
    ...
    [TXT_SETTINGS_CPU_MUSIC] = "Spectrum CPU",
    [TXT_CPU_REQUIRED] = "Needs StreamerOC: enabled=1, app_control=1",
    [TXT_CPU_ERROR] = "Clock request failed: %08X; check plugin INI",
    [TXT_CPU_READY] = "Plugin ready. OC ceiling: plugin INI. START saves.",
    ...
    [TXT_OC_ENABLED] = "Enabled",
    [TXT_OC_TARGET] = "Target clock",
    [TXT_OC_ENFORCE] = "Enforce",
    [TXT_OC_UNLIMITED] = "Unlimited enforcement",
    [TXT_OC_APP_CONTROL] = "App control",
    [TXT_OC_REPORT] = "Log reports",
    [TXT_OC_OVERLAY] = "Overlay",
    [TXT_OC_POLLING] = "1: polling",
    [TXT_OC_HOOK] = "2: framebuffer hook",
    [TXT_OC_WARNING] = "Only use clocks already tested on this PSP!",
    [TXT_OC_HELP] = "START SAVE FOR NEXT APP START   O CANCEL",
    [TXT_OC_SAVED] = "Plugin saved; applies on next app start",
    [TXT_OC_READ_FAILED] = "Cannot read plugin INI safely. O BACK",

    [TXT_SCREEN_AWAKE] = "Keep awake",
    [TXT_SCREEN_MUSIC] = "Auto: music only",
    [TXT_SCREEN_AUTO] = "Auto: always",
    [TXT_OUTPUT_LCD] = "Switch menu to LCD [X]",
    [TXT_OUTPUT_TV] = "Switch menu to TV [X]",
    [TXT_OUTPUT_FAILED] = "Check component cable / TV: %08X",
    [TXT_OUTPUT_ON_LCD] = "Menu: LCD; video follows cable",
    [TXT_OUTPUT_ON_TV] = "Menu: TV",
    ...
    [TXT_STREAM_START_WAIT] = "Waiting %us - START: stop",
    [TXT_STREAM_WAIT_DATA] = "Waiting for playable video data",
    [TXT_RADIO_RECONNECT] = "Radio retry in 5s - START: stop",
    [TXT_PLAYLIST] = "Playlist",
    [TXT_PLAYLIST_UP] = "Move up",
    [TXT_PLAYLIST_DOWN] = "Move down",
    [TXT_PLAYLIST_REMOVE] = "Remove entry",
    [TXT_PLAYLIST_ENABLE] = "Use playlist order",
    [TXT_PLAYLIST_DISABLE] = "Use folder order",
    [TXT_PLAYLIST_HINT] = "X: play | Triangle: edit playlist",
    [TXT_QUEUE_REPEAT_OFF] = "List repeat: off",
